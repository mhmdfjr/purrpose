      ...
      <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="text-sm font-bold text-foreground/60">
            Kelola identitas, lokasi, dan koleksi badge.
          </p>
        </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2 flex flex-wrap gap-1.5">
                  ...
                  {profile?.cityManualOverride ? (
                    <Badge className="bg-[var(--color-info)] text-white border-black font-black text-xs">
                      manual
                    </Badge>
                  ) : (
                    <Badge
                  ...
                  <Badge
                    variant="neutral"
                    className="bg-white border-black font-black gap-1"
                  >
                ...
                <div className="mt-2 flex flex-wrap gap-1.5 text-xs font-bold">
                  ...
                  {joinDate && (
                    <span className="border-2 border-border bg-white px-2 py-1">
                      Bergabung {joinDate}
                    </span>
                  )}
                </div>
            ...
            {totalBadges > 0 && (
              <div className="mt-3">
                ...
                <p className="text-xs font-bold text-foreground/60 mt-1">
                  {totalBadges} badge terkumpul - koleksi terus!
                </p>
              </div>
            )}
          </CardContent>
      ...
      <Card className="border-2 shadow-shadow bg-secondary-background">
        <CardHeader className="border-b-2 pb-2 border-border bg-white">
          ...
          <p className="text-xs font-bold text-foreground/60">
            Ubah display name, kota (manual override), timezone, dan preferensi
            AI.
          </p>
        </CardHeader>
        <form onSubmit={handleSave}>
          <CardContent className="space-y-4 py-6">
            ...
            <div className="grid gap-2">
              ...
              <p className="text-xs font-bold text-foreground/60">
                Auto-detected:{" "}
                {Intl.DateTimeFormat().resolvedOptions().timeZone} • Mengubah
                timezone akan hitung ulang UTC reset hour.
              </p>
            </div>
            ...
            <div className="flex items-center justify-between border-2 border-border bg-white p-3 shadow-sm">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs font-bold text-foreground/60">
                    Gemini free-tier, aktifkan untuk saran AI di weekly report.
                  </p>
                </div>
              </div>
              <Switch
          ...
          {badgesLoading ? (
            ...
            <div className="text-center py-10 border-2 border-dashed border-border bg-[var(--neo-gray-100)]">
              ...
              <p className="text-xs font-bold text-foreground/60 max-w-md mx-auto mt-1">
                Masuk Top 3 leaderboard mingguan untuk dapat badge! Badge
                Gold/Silver/Bronze sesuai tier DESIGN.md §7 dan tersimpan
                permanen.
              </p>
            </div>
          ) : (
